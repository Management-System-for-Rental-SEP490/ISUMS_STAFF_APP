export default {
    ...
    "login_validation_required": "ユーザー名とパスワードを入力してください",
    "cannot_open_link": "リンクを開けません",
    "non_technical_blocked_title": "許可されていません",
    "non_technical_blocked_message": "このアカウントはスタッフアプリを使用する権限がありません。",
    ...
    "staff_item_list": {
        "title": "デバイス一覧",
        "subtitle": "建物を選び（一度に一棟）、検索して担当デバイスを管理します。",
        "empty": "デバイスがまだありません。",
        "error": "デバイス一覧を読み込めませんでした。もう一度お試しください。",
        "no_houses_assigned": "担当の建物がありません。",
        "category_other": "その他",
    ...
    "staff_work_slot_detail": {
        ...
        "job_section": "業務情報",
        "job_section_expand": "タップして詳細を見る",
        "job_section_collapse": "閉じる",
        "time_range": "時間帯",
        "date": "日付",
        "job_type": "業務種別",
        "status": "ステータス",
        ...
        "btn_report_unlivable": "居住不可と報告",
        "unlivable_report_alert_title": "居住不可の報告を送信します",
        "relocation_in_flight_label": "転居報告書が処理中です",
        "relocation_blocking_label": "住居不可と報告された物件",
        "relocation_blocking_hint": "代替物件または敷金返金についてマネージャーの判断待ちです。この検査は確定できません — 代替物件があれば新しい検査がマネージャーから発行されます。",
        "relocation_status_requested": "承認待ち",
        "relocation_status_quoted": "見積り回答待ち",
        "relocation_status_approved": "承認済み",
        "relocation_status_contract_created": "代替契約を作成済み",
        "relocation_status_additional_payment_pending": "追加支払い待ち",
        "relocation_status_refund_pending": "返金待ち",
        "relocation_status_completed": "完了",
        "relocation_status_rejected": "却下",
        "relocation_status_cancelled": "キャンセル",
        "toggle_broken_label": "破損",
        "baseline_checkin": "チェックイン: {{percent}}% · {{note}}",
    },
    "staff_landlord_fault_report": {
        "screen_title": "居住不可の物件を報告",
        "banner": "火災・浸水・倒壊などにより物件を引き渡せない場合に使用します。マネージャーが代替物件の手配または敷金の返金を行います。",
        "house_label": "物件",
        "house_placeholder": "物件名なし",
        "contract_label": "影響を受ける契約",
        "contract_loading": "契約情報を読み込み中…",
        "contract_unknown": "契約番号を特定できませんでした",
        "contract_load_error": "契約情報の読み込みに失敗しました。",
        "reason_label": "被害状況の説明",
        "reason_placeholder": "例：キッチンが焼損、電気系統が危険、入居継続不可…",
        "evidence_label": "証拠（現場写真）",
        "evidence_empty_hint": "現場写真を1枚以上撮影してください。最大{{max}}枚。",
        "evidence_add_button": "証拠写真を撮影",
        "evidence_counter": "{{current}}/{{max}} 枚選択済み",
        "recommended_house_label": "代替物件の提案（任意）",
        "recommended_house_section": "同エリアの空き物件",
        "recommended_house_none": "代替物件を選択していません",
        "recommended_house_picked": "代替物件を選択しました",
        "recommended_house_empty": "提案できる空き物件がありません。",
        "submit_button": "報告書を送信",
        "submit_success": "報告書を送信しました。マネージャーが代替物件の手配または敷金返金を行います。",
        "submit_failed": "報告書の送信に失敗しました。もう一度お試しください。",
        "error_no_contract_number": "対象契約の契約番号を特定できません。",
        "error_no_reason": "被害状況を入力してください。",
        "error_no_evidence": "現場写真を1枚以上添付してください。"
    },
