export default {
    ...
    "non_technical_blocked_title": "Not allowed",
    "non_technical_blocked_message": "This account does not have permission to use the staff app.",
    ...
    "login_timeout_message": "Login took too long. Please try again.",
    "login_failed_title": "Login failed",
    "login_failed_generic": "Something went wrong",
    "login_oauth_error_title": "Login error",
    "common": {
        "back": "Back",
        "no_data": "No data",
        "loading": "Loading...",
    ...
    "staff_home": {
        ...
        "schedule_summary_title": "Work today & tomorrow",
        ...
        "buildings_title": "Buildings in your area",
        "quick_actions_title": "Quick actions",
        "add_menu_assign_tag": "Assign tag",
    ...
    "staff_category": {
        ...
        "auto_translate_label": "Auto multilingual",
        "auto_translate_hint": "On: enter one name (and optional description); the backend may fill other languages. Off: swipe Vi / En / Ja to enter name and description per language.",
        "mode_badge_auto": "AUTO",
        "mode_badge_manual": "MANUAL",
        "auto_name_label": "Category name (Vietnamese)",
        "manual_locales_warning": "Manual mode: enter the category name in Vietnamese, English, and Japanese.",
        "manual_description_label": "Description",
        "compensation_label_trilingual": "Percent (%) · applies to the category in every step",
        "toggle_description_label": "Add description",
        "toggle_description_hint": "Off: send name and percent only (no description). On: include a description in auto mode.",
        "name_label": "Category name",
        "name_placeholder": "e.g. Air conditioner, Light bulb",
        "compensation_label": "Percent (%)",
    ...
    "staff_category_list": {
        ...
        "search_category_only": "Search categories (name, description, percent)…"
    },
    "staff_item_list": {
        "title": "Device list",
        "subtitle": "Choose a house (one at a time), search, and manage assigned devices.",
        "empty": "No devices yet.",
        "error": "Could not load devices. Please try again.",
        "no_houses_assigned": "You have no houses assigned.",
    ...
    "staff_item_create": {
        ...
        "images_hint": "Up to {{max}} photos.",
        "images_empty": "No images",
        "library_permission_no_permission": "No access to photo library",
        "submit": "Add device",
        "success_message": "Device added.",
        "success_pending_approval": "Created successfully. Awaiting manager approval.",
        "error_message": "Something went wrong. Please try again.",
        "error_forbidden": "You don't have permission to do this.",
        "error_validation": "Invalid data. Check the fields you entered.",
        "auto_translate_label": "Auto-translate (EN / JA)",
        "auto_translate_hint": "On: enter the Vietnamese display name only; the system may translate the name to English/Japanese. Off: enter the display name in all three languages.",
        "mode_badge_auto": "AUTO",
        "mode_badge_manual": "MANUAL",
        ...
        "description_vi_placeholder": "Short description in Vietnamese",
        "locale_section_vi": "Vietnamese",
        "locale_section_en": "English",
        "locale_section_ja": "Japanese",
        "name_en_label": "Name",
        ...
        "name_ja_label": "名称",
        "name_ja_placeholder": "Display name in Japanese",
        "description_ja_label": "説明",
        "description_ja_placeholder": "Description in Japanese",
        "manual_locales_warning": "Manual mode: fill the display name for Vietnamese, English, and Japanese.",
        "manual_swipe_hint_short": "Switch language using the dots below",
        "confirm_modal_title": "Confirm multilingual display name",
        "confirm_save": "Save changes",
        "confirm_done": "Done",
        "confirm_save_success": "Display name updated.",
        "confirm_readonly_hint": "You can only review this content.",
    ...
    "staff_item_edit": {
        "title": "Edit device",
        "readonly_pending_manager": "This device is pending manager approval. You can view details only; editing is disabled.",
        "tag_segment_nfc": "NFC",
        "tag_segment_qr": "QR",
        "submit": "Update",
    ...
    "staff_item_description": {
        ...
        "edit_btn": "Edit",
        "note_label": "Note",
        "note_placeholder": "Enter a note for this item...",
    ...
    "staff_ticket_list": {
        ...
        "status_WAITING_STAFF_COMPLETION": "Awaiting payment method",
        "status_WAITING_CASH_PAYMENT": "Awaiting cash confirmation",
    ...
    "staff_calendar": {
        ...
        "job_type_INSPECTION": "Handover inspection",
        ...
        "job_status_WAITING_STAFF_COMPLETION": "Awaiting payment method",
    ...
    "staff_nfc": {
        ...
        "valid_devices_label": "Eligible devices",
        "valid_devices_list_section": "Devices",
        "search_valid_devices": "Search"
    },
    "staff_work_slot_detail": {
        "title": "Work slot details",
        "work_slot_section": "Work slot info",
        "job_section": "Job info",
        "job_section_expand": "Tap to view details",
        "job_section_collapse": "Collapse",
        ...
        "inspection_period_label": "Created on",
        "inspection_type_label": "Inspection type",
        "inspection_type_CHECK_IN": "Check-in",
        "inspection_type_CHECK_OUT": "Check-out",
        "inspection_note_label": "Request note",
        "due_date": "Due date",
        ...
        "completion_alert_title": "Completed",
        ...
        "maintenance_modal_title_inspection": "Inspection asset updates",
        ...
        "btn_report_unlivable": "Report unlivable house",
        "unlivable_report_alert_title": "Submit uninhabitable housing report",
        "relocation_in_flight_label": "Relocation report in progress",
        "relocation_blocking_label": "House reported unfit for occupancy",
        "relocation_blocking_hint": "Awaiting manager decision (replacement house or refund). You cannot confirm this inspection — manager will issue a new inspection at the replacement house (if any).",
        "relocation_status_requested": "Pending review",
        "relocation_status_quoted": "Awaiting tenant quote response",
        "relocation_status_approved": "Approved",
        "relocation_status_contract_created": "Replacement contract created",
        "relocation_status_additional_payment_pending": "Awaiting extra payment",
        "relocation_status_refund_pending": "Awaiting refund",
        "relocation_status_completed": "Completed",
        "relocation_status_rejected": "Rejected",
        "relocation_status_cancelled": "Cancelled",
        "toggle_broken_label": "Broken",
        "baseline_checkin": "Check-in: {{percent}}% · {{note}}",
    },
    "staff_landlord_fault_report": {
        "screen_title": "Report unlivable house",
        "banner": "Use this when the house is on fire, flooded, collapsed, or otherwise unsafe and can no longer be handed over. The manager will arrange a replacement house or refund the deposit.",
        "house_label": "House",
        "house_placeholder": "No house name",
        "contract_label": "Affected contract",
        "contract_loading": "Loading contract…",
        "contract_unknown": "Could not resolve contract number",
        "contract_load_error": "Failed to load contract information.",
        "reason_label": "Description of damage",
        "reason_placeholder": "e.g. kitchen burned, electrical system unsafe, cannot continue letting the tenant stay…",
        "evidence_label": "Evidence (on-site photos)",
        "evidence_empty_hint": "Take at least 1 on-site photo. Up to {{max}} photos.",
        "evidence_add_button": "Capture evidence photo",
        "evidence_counter": "{{current}}/{{max}} photos selected",
        "recommended_house_label": "Suggest a replacement house (optional)",
        "recommended_house_section": "Available houses in this area",
        "recommended_house_none": "No replacement selected",
        "recommended_house_picked": "Replacement selected",
        "recommended_house_empty": "No vacant houses are available to suggest.",
        "submit_button": "Submit report",
        "submit_success": "Report submitted. The manager will arrange a replacement house or refund the deposit.",
        "submit_failed": "Failed to submit the report. Please try again.",
        "error_no_contract_number": "Could not resolve a contract number for this report.",
        "error_no_reason": "Please describe the damage.",
        "error_no_evidence": "Please attach at least one on-site photo."
    },
    "staff_inspection_confirm": {
        "title": "Confirm inspection",
        "house_label": "House",
        "house_placeholder": "No house name",
        "default_notes_check_in": "Ready for handover",
        "default_notes_check_out_ok": "Normal condition",
        "photos_label": "Photos from this session",
        "no_photos": "No photos",
        ...
        "deduction_label": "Proposed deduction total",
    ...
    "staff_issue_note": {
        ...
        "device_label": "Device",
        "device_name_loading": "Loading…",
        "device_name_fallback": "Device ({{ref}})",
        ...
        "billing_mode_tenant": "Tenant",
        "billing_mode_internal": "Internal",
        ...
        "banner_multi_hint": "Tap items to select or deselect. Tap collapse on the list to confirm your selection.",
        ...
        "cost_field_label": "Purchase cost (cost)",
        "price_field_label": "Tenant price (price)",
        "price_field_label_internal": "Internal / tracking price (price)",
        "amount_placeholder": "Enter amount, e.g. 100000",
    ...
    "home": {
        "footer": {
            "aria_label": "App info and support links",
            "badge": "STAFF BUILD",
            "build": "Build 2026.04.12",
            "support_line":
                "Need help? Contact the ISUMS hotline or your building administrator.",
        ...
        "staff_tab_greeting_morning": "Good morning, {{name}}",
        "staff_tab_greeting_noon": "Good afternoon, {{name}}",
        "staff_tab_greeting_afternoon": "Good afternoon, {{name}}",
        "staff_tab_greeting_evening": "Good evening, {{name}}",
        "staff_tab_greeting_night": "Hello, {{name}}",
