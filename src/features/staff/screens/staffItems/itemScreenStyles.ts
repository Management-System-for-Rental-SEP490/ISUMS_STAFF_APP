...
export const itemScreenStyles = StyleSheet.create({
  ...
  /** Tạo thiết bị — hàng toggle dịch tự động */
  autoTranslateRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  /** Khối pager 3 form (tắt auto dịch) + chấm trang */
  manualLocalePagerBlock: {
    marginTop: 8,
    marginBottom: 4,
  },
  manualLocaleDotsRow: {
  ...
  /** Nhãn một dòng gồm VI / EN / JA (luôn hiển thị đủ ba). */
  labelTrilingual: {
    fontSize: 11,
    fontWeight: "600",
    color: neutral.textMuted,
  ...
  /** Multiline trong cột hẹp (hàng ngang) */
  inputMultilineRow: {
    minHeight: 108,
  },
  inputMultiline: {
  ...
  confirmModalBtnTextSecondary: {
    fontSize: 15,
    fontWeight: "600",
    color: neutral.textBody,
  },
  confirmModalBtnTextPrimary: {
    fontSize: 15,
    fontWeight: "600",
    color: "#fff",
  },
