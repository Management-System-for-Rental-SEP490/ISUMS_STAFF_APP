...
export const STATUS_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  WAITING_STAFF_COMPLETION: { bg: brandTintBg, text: brandPrimary },
  WAITING_CASH_PAYMENT: { bg: brandTintBg, text: brandSecondary },
...
export const staffWorkSlotStyles = StyleSheet.create({
  ...
  relocationBadgeLabel: {
    flex: 1,
    fontSize: 13,
    fontWeight: "600",
    color: "#92400e",
  },
  relocationBadgeStatus: {
    fontSize: 13,
    fontWeight: "800",
    color: "#92400e",
  },
  relocationBadgeBlocking: {
  ...
  relocationBadgeLabelBlocking: {
    color: "#991b1b",
    fontSize: 13,
    fontWeight: "700",
  },
  relocationBadgeBlockingHint: {
    marginTop: 4,
    fontSize: 12,
    color: "#7f1d1d",
    lineHeight: 17,
  },
  relocationBadgeStatusBlocking: {
    color: "#991b1b",
    alignSelf: "flex-start",
    marginTop: 4,
